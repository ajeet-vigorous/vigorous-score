...
function Home() {
    ...
    return (
<div className="container d-flex flex-column align-items-center  vh-100 bg-light text-dark home-container">
  <div className="display-4 mb-4 text-primary">Match List</div>

  <div
    className="list-group shadow-lg overflow-auto"
      ...
      matches.map((match, index) => (
        ...
        >
          ...
          <div style={{ gap: '2px' }} className="d-flex">
            <span
              onClick={() => navigate(`/socket-iframe-1/crex/${match.eventId}`)}
              className="badge bg-primary rounded-pill match-item"
            >
              View crex
            </span>
            <span
              onClick={() => navigate(`/socket-iframe-1/crickexpo/${match.eventId}`)}
              className="badge bg-primary rounded-pill match-item"
            >
              View crickexpo
            </span>
