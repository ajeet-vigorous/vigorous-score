...
console.log(matchScoreDetails,'matchScoreDetails')
  ...
  return (
    <>
      ...
      <>
      <div className="iframe2_content iframe_16_content h-25 overflow-hidden py-2">
        <div className="sc_cw-container-main">
            <div className="sc_cw-row-ctm">
                <div className="sc_cw-batsman_svg">
                  <img className="" src="/batsman-bold-outline.svg" alt="" srcset="" />
                </div>
                <div className="sc_cw-team">
                  <div className="sc_cw-curr_inn">
                      <div className="sc_cw-curr_inn_text">
                      ...
                      <div className="sc_cw-curr_inn_text">
                        {(matchScoreDetails?.score?.team1_score || 0)}
                        {" "}
                        ({matchScoreDetails?.score?.team1_over || 0})
                      </div>
                      <div className="sc_cw-curr_inn_text">
                        {(matchScoreDetails?.score?.team2_score || 0)}
                        {" "}
                        ({matchScoreDetails?.score?.team2_over || 0})
                        </div>
                      <div className="sc_cw-curr_inn_text">54545</div>
                  </div>
                </div>
                <div className="sc_cw-match_status">
                  <div className="sc_cw-target"> DAY 4 STUMPS</div>
                  <div className="sc_cw-day">
                  ...
                  <div className="sc_cw-requiredRunRate">
                    ENG need 228 runs to win
                  </div>
                ...
                <div className="sc_cw-batsman_svg">
                  <img className="" src="/baller-bold-outline.svg" alt="" srcset="" />
                </div>
            </div>
        </div>
